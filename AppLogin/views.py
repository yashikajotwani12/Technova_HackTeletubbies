from AppLogin.forms import ProfilePic, SignUpForm, UserProfileChange
...
from AppLogin.forms import SignUpForm,UserProfileChange,ProfilePic
...
def pass_change(request):
    ...
    return render(request,'AppLogin/pass_change.html',context={'form':form,'changed':changed})
...
def add_pro_pic(request):
    ...
    return render(request, 'AppLogin/pro_pic_add.html',context={'form':form})
